...
export default function ImageDropZone(props) {
  ...
  const handleImageUpload = () => {
    try {
      ...
      uploadTask.on(
        ...
        async () => {
          ...
          let newPhoto = {
            ...
            createdAtServerTime: firebase.firestore.FieldValue.serverTimestamp(),
            bucket,
            fullPath,
          };
          ...
          toast.success("Image is uploaded and text is detected!", {
      ...
      toast.error("Failed to upload image and detect text!", {
        position: toast.POSITION.TOP_CENTER,
        autoClose: 2000,
      });
    }
